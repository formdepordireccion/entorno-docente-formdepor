---
name: asig-examen
description: Genera instrumentos de evaluación de la asignatura resuelta (exámenes, rúbricas, banco de preguntas) vinculados a resultados de aprendizaje y criterios de evaluación, con su solucionario en archivo separado. Úsalo cuando el usuario pida un examen, rúbrica, banco de preguntas o solucionario de la asignatura resuelta.
---

# /asig-examen — Evaluación
...
7. Guarda el instrumento visible en
   `08_EVALUACION/<CODIGO>_EXAMEN_UD<NN>_2026-2027_V01_BORRADOR.md` y el
   solucionario en un archivo **separado**:
   `08_EVALUACION/<CODIGO>_EXAMEN_UD<NN>_2026-2027_V01_BORRADOR_SOLUCIONARIO.md`,
   donde `<CODIGO>` es el código de la asignatura (resuelto según CLAUDE.md → "Cómo se resuelve la asignatura").
