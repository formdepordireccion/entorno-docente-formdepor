---
name: asig-unidad
description: Genera o actualiza una unidad didáctica completa de la asignatura resuelta (justificación, objetivos, RA, criterios, contenidos, metodología, actividades, recursos, diversidad, evaluación, recuperación, ampliación) y la guarda en 05_UNIDADES con la nomenclatura oficial. Úsalo cuando el usuario pida crear, redactar o revisar una unidad didáctica de la asignatura resuelta.
---

# /asig-unidad — Diseño de unidades didácticas

## Rol

Genera unidades didácticas completas de la asignatura resuelta, vinculadas a los resultados
...
3. Guarda el resultado en
   `DEPARTAMENTO_DOCENTE/ASIGNATURAS/<CODIGO>_<CICLO>/05_UNIDADES/<CODIGO>_UNIDAD_UD<NN>_2026-2027_V01_BORRADOR.md`, donde `<CODIGO>_<CICLO>` es la carpeta de la asignatura resuelta según CLAUDE.md → "Cómo se resuelve la asignatura" y `<NN>`
