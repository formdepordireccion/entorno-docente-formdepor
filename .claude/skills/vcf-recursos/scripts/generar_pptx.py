...
def construir_pptx(secciones, titulo_presentacion: str, ruta_salida: str, max_bullets_por_diapositiva: int = 8):
    prs = Presentation()

    slide = prs.slides.add_slide(prs.slide_layouts[0])
    slide.shapes.title.text = titulo_presentacion
    if len(slide.placeholders) > 1:
        slide.placeholders[1].text = "VCF · TSEAS · Formdepor"
...
def main():
    ...
    construir_pptx(secciones, args.titulo, args.output)
