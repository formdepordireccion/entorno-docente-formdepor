...
lo que `/vcf-tema` es al temario: reutiliza como inspiración lo que ya
...
4. Numera la tarea siguiendo la secuencia ya usada para esa unidad en
   **cualquier** subcarpeta de `07_ACTIVIDADES_TAREAS/VIGENTE/` (revisa
   ...
   categorías).
5. Guarda como
   `07_ACTIVIDADES_TAREAS/VIGENTE/<N_CARPETA>/VCF_TAREA_UD<NN>_<N>_2026-2027_V01_BORRADOR.md`,
   donde `<N_CARPETA>` es la subcarpeta de la categoría elegida,
